...
class TestBoredomFrustration extends AnyFunSuite:
  ...
  test(
    ...
    val mock = Customer(boredom = 70.0, frustration = 20.0)
  ...
  test(
    ...
    val exB = intercept[IllegalArgumentException] {
      Customer(boredom = negativeValue, frustration = 30.0)
    }
    val exF = intercept[IllegalArgumentException] {
      Customer(boredom = 30.0, frustration = negativeValue)
    }
    assert(
  ...
  test(
    ...
    val mock = Customer(boredom = 50, frustration = 70)
  ...
  test(
    ...
    val startValue = 90.0
    val mock = Customer(boredom = startValue, frustration = startValue)
    val netChange = 100.0
